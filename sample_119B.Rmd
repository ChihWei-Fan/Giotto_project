...
visium_sample_119B <- calculateHVF(gobject = visium_sample_119B, save_plot = TRUE, show_plot = T)
```
...
dimPlot2D(gobject = visium_sample_119B, dim_reduction_to_use = "pca",point_size = 3, axis_text = 12, axis_title = 12)
```
...
plotUMAP(gobject = visium_sample_119B, point_size = 3, axis_text = 12, axis_title = 12)
```
...
spatFeatPlot2D(visium_sample_119B, expression_values = 'scaled',
               feats = top10_APOE_genes$variable[1:9], point_size = 1.8, axis_text = 7, axis_title = 9, cow_rel_h = 7 , cow_rel_w = 9 , legend_text = 7,cow_n_col = 3)
...
spatFeatPlot2D(visium_sample_119B, expression_values = 'scaled',
               feats = top10_FABP4_genes$variable[1:10], point_size = 2, axis_text =9, axis_title = 10, cow_rel_h = 7 , cow_rel_w = 9 , legend_text = 7,cow_n_col = 3)
