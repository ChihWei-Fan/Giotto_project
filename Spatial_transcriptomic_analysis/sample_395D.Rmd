...
```
```{r}
dimPlot2D(gobject = visium_sample_119B, dim_reduction_to_use = "pca")
```
...
## Leiden clustering
visium_sample_119B <- doLeidenCluster(gobject = visium_sample_119B, resolution = 0.4, n_iterations = 1000)
...
spatPlot2D(visium_sample_119B, cell_color = 'leiden_clus',
           coord_fix_ratio = 1)
```
